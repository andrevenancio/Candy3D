...
CANDY3D.Tom = function(width, height, segmentsW, segmentsH) {
...
CANDY3D.Tom.prototype.build = function(width, height) {


  for i in [0...@CANDY3D.Tom.pointData.length] by 4
...
CANDY3D.Tom.pointData = function() {
  return [
    -34,2,-33, 36,
    -34,3,-33, 36,
    -34,4,-33, 38,
